        ...
        <div className="bg-white p-10 rounded-[3.5rem] shadow-2xl border border-white/20 backdrop-blur-3xl">
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                type="submit" 
                className="w-full py-6 bg-emerald-600 hover:bg-emerald-700 text-white font-black text-sm uppercase tracking-[0.2em] rounded-3xl shadow-lg shadow-emerald-200 transform hover:-translate-y-1 transition-all flex justify-center items-center gap-3"
              >
