...
import { PROVINCES, WARDS_MAP, COOPERATIVES, COOPERATIVE_CONFIGS } from '../../data';
...
export default function RegistrationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Kết nối API
    try {
      await farmerService.createFarmerRequest(newRequest);
    } catch (error) {
      console.warn("Failed to create registration request via API, continuing with local storage", error);
    }
